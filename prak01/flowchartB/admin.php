                        ...
                        <div class="col-lg-5">
                            <div class="card shadow-lg border-0 rounded-lg mt-5 bg-dark">
                                <div class="card-header">
                                    <h2 class="text-center font-weight-light my-4 text-white">Selamat Datang, <?php echo $_SESSION['admin']; ?>!</h2>
                                    <p class="text-center font-weight-light my-4 text-white">You're logged in as admin.</p>
                                </div>
                            </div>
                        </div>
                    </div>
