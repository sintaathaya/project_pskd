                        ...
                        <div class="col-lg-5">
                            <div class="card shadow-lg border-0 rounded-lg mt-5 bg-transparent">
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4 text-white">VIGENERE CHIPER</h3>
                                </div>
                                <div class="card-body">
                                    <form action="enkVigenere.php" method="get">
                                        <div class="form-floating mb-3">
                                            <input class="form-control" name="key" id="kunci" type="text" />
                                    ...
                                    <br> <br>
                                    <form action="dekVigenere.php" method="get">
                                        <div class="form-floating mb-3">
                                            <input class="form-control" name="key" id="kunci" type="text" />
                                                <label for="Kunci" class="form-label">Kunci</label>
                                        </div>
